...
.  .  \u2717  \u32BF F5 F11  . .  F12 F6  .  .  .
.      .   .         .         .   .   .   .`},A=a.standard;R();a.shift=F(a.standard);a.symShift=F(a.sym,!1);a.standardHtk=a.standard.map(r=>S(r));a.extHtk=a.ext.map(r=>S(r));a.ext2Htk=a.ext2.map(r=>S(r));a.standardRows=I(A);a.standardHtkRows=I(A.split("").map(r=>S(r)).join(""));function R(){Object.entries(a).forEach(([r,e])=>a[r]=e.replace(`
`,"").replaceAll(`
`," ").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(" "))}function I(r){const e=["top","upper","home","lower","bottom"],t=r.replace(`
`,"").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(`
`);return t.forEach((o,s)=>t[s]=o.split(" ")),Object.fromEntries(e.map((o,s)=>[o,t[s]]))}function F(r,e=!0){return r.map(t=>{if(e&&t==".")return">";switch(t){case"`":return"~";case"1":return"!";case"2":return"@";case"3":return"#";case"4":return"$";case"5":return"%";case"6":return"^";case"7":return"&";case"8":return"*";case"9":return"(";case"0":return")";case"=":return"+";case"-":return"_";case"\\":return"|";case"/":return"?";case"[":return"{";case"]":return"}";case",":return"<";case";":return":";case"'":return'"';default:return t.length==1&&t>="a"&&t<="z"?t.toUpperCase():t}})}function S(r){switch(r){case"\u{1F4B2}":return"F23";case"\u2B50":return"F24";case"\u2297":return"Esc";case"\u238B":return"Esc";case"\u21C4":return"Tab";case"\u23CE":return"Enter";case"\u21EA":return"Capslock";case"\u21E7":return"LShift";case"\u2A01":return"LCtrl";case"\u229E":return"LWin";case"\u2263":return"AppsKey";case"\u232B":return"Bs";case"\u2326":return"Del";case"\u21F1":return"Home";case"\u21F2":return"End";case"\u21DE":return"PgUp";case"\u21DF":return"PgDn";case"\u2191":return"Up";case"\u2193":return"Down";case"\u2192":return"Right";case"\u2190":return"Left";case"\u25B4":return"mouseU";case"\u25BE":return"mouseD";case"\u25B8":return"mouseR";case"\u25C2":return"mouseL";case"\u25F4":return"LButton";case"\u25F7":return"RButton";case"\u29BA":return"MButton";case"\u21A9":return"XButton1";case"\u21AA":return"XButton2";case"\u21C8":return"WheelDown";case"\u21CA":return"WheelUp";case"\u2387":return"speed";case"\u23EF":return"Media_Play_Pause";case"\u25FC":return"Media_Stop";case"\u23ED":return"Media_Next";case"\u23EE":return"Media_Prev";case"\u{1F507}":return"Volume_Mute";case"\u{1F50A}":return"Volume_Up";case"\u{1F509}":return"Volume_Down";case"\u2600":return"brightnessUp";case"\u2733":return"brightnessDown";case"\u{1F50D}":return"Browser_Search";case"\u229A":return"^Numpad0";case"\u2295":return"^NumpadAdd";case"\u229D":return"^NumpadSub";case"\u2399":return"PrintScreen";case"\u{1F4F1}":return"Run calc";case"%":return"`%";case";":return"`;";default:return r}}const M=document.createElement("div");M.id="keyboard";for(let[r,e]of Object.entries(a.standardRows)){const t=document.createElement("div");t.id=`${r}_row`,t.className="row",e.forEach((o,s)=>{const c=document.createElement("button");c.textContent=o,c.className=D(a.standardHtkRows[r][s]),"\u232B \u21C4 \u23CE alt \u21E7 \u229E \u2A01 \u{1F4B2} space \u2B50 \u2263".split(" ").includes(o)&&c.classList.add("modifier"),t.append(c)}),M.append(t)}function D(r){if(+r||r==0)return`_${r}`;switch(r){case"`":return"backtick";case"-":return"hyphon";case"=":return"equal";case"/":return"slash";case"\\":return"backSlash";case"[":return"openBreacket";case"]":return"closeBracket";case"'":return"quate";case"`;":return"semiColon";case",":return"comma";case".":return"period";default:return r}}const H=document.createElement("legend");H.innerText="layout switcher";const h=document.createElement("fieldset");h.id="switcher";h.append(H);h.name="layer";ee("power","standard","shift","ext","ext2","sym","symShift","sym2");function k(){const r=document.querySelectorAll("#keyboard button");h.addEventListener("change",({target:{value:e}})=>r.forEach((t,o)=>t.textContent=a[e][o]))}function ee(...r){r.forEach(e=>{const t=document.createElement("label"),o=document.createElement("input");o.type="radio",o.id=`radio_${e}`,o.name="layer",o.value=e,e=="standard"&&o.setAttribute("checked",!0),t.id=`label_${e}`,t.append(o,e),h.append(t)})}const U=document.createElement("div");U.id="panel";U.append(h,te());function te(){const r=document.createElement("a");r.textContent="MsKLC.zip",r.href="./../ahk/msklc.zip",r.download="msklc.zip";const e=document.createElement("a");e.textContent="AutoHotKey.zip",e.href="./../ahk/UniParse.zip",e.download="autohotkey.zip";const t=document.createElement("div");return t.id="download",t.append(r,e),t}var re="./assets/pop1.b5fe646f.wav",ne="./assets/pop2.5719bcba.wav",se="./assets/pop3.4711d144.wav";const N=[re,ne,se];N.forEach(r=>new Audio(r));const oe=M.querySelectorAll("button");function ae(){document.addEventListener("keydown",({key:r,code:e})=>{console.log(e,r);const t=[].find.call(oe,o=>o.innerText==r||o.className.split(" ").find(s=>s==r||s=="_"+r||s=="space"&&r==" "||s=="LShift"&&r=="Shift"));!t||(new Audio(N[Math.floor(Math.random()*3)]).play(),t.style.borderStyle="inset",t.className.includes("modifier")?t.style.backgroundColor="darkcyan":t.style.backgroundColor="#333",document.addEventListener("keyup",function o({key:s}){r==s&&(document.removeEventListener("keyup",o),t.style.borderStyle="outset",t.className.includes("modifier")?t.style.backgroundColor="#222":t.style.backgroundColor="#666")},{once:!1}))})}const i="F23",l="F24",w=[-400,2],f={symKey:i,extKey:l};f.intro=`;
;
;   made by UniParse
;   github.com/TheUniParse
...
`;f.switchers=`	${i}::
  ...
  speed_${e}_timer:
    ...
    press_${e} = 0
    Return
`;x.getHover=(r,e,t,o,s)=>{return c(e)+c(o)+c(t)+c(s);function c(n){return`	${n}::
    If !move_${n} {
  ...
  speed_${n}_timer:
    ...
    press_${n} = 0
    Return
`;function $(p,E=0){if(E){if(E==1){if(p==e||p==s)return"-x, -y";if(p==t)return"x, -y";if(p==o)return"-x, y"}else if(E==2){if(p==e)return"x, -y";if(p==t||p==o)return"x, y";if(p==s)return"-x, y"}}else{if(p==e)return"0, -y";if(p==t)return"x, 0";if(p==o)return"0, y";if(p==s)return"-x, 0"}}function u(p){if(p==s)return t;if(p==t)return s;if(p==e)return o;if(p==o)return e}}};const d=a.standard.map(r=>r==";"?"`;":r);let V,Y,W,J;const L=`${f.intro}
...
#If ${f.layer_condition.ext}
${x.getHover(f.extKey,W,Y,J,V)}
${x.getWheel(f.extKey,"q","wheelUp")}
${x.getWheel(f.extKey,"a","wheelDown")}#If`;function K(r=0){let e="";return a[r?"ext2Htk":"extHtk"].forEach((t,o)=>{switch(t){case"LButton":case"RButton":case"MButton":case"XButton1":case"XButton2":e+=`	${d[o]}::${t}
`;break;case"Capslock":e+=`	${d[o]}::SetCapsLockState, % GetKeyState("CapsLock","T") ? "Off" : "On"
		return
`;break;case"mouseL":V=d[o];break;case"mouseR":Y=d[o];break;case"mouseU":W=d[o];break;case"mouseD":J=d[o];break;case"brightnessUp":e+=O(d[o],1);break;case"brightnessDown":e+=O(d[o]);break;case"speed":e+=`	${d[o]}::
		speed_switcher := !speed_switcher
		resetSpeed()
		return
`;break;default:t!="."&&!t.includes("mouse")&&!t.includes("Wheel")&&(e+=`	${d[o]}::${t}
`)}}),e}function ce(){let r="";return a.sym.forEach((e,t)=>{+e||"0`\\/=[]".includes(e)?r+=`	${d[t]}::${e}
`:e>"~"?r+=`	${d[t]}::Send {${P(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::SendRaw ${e}
		return
`)}),r}function ie(){let r="";return a.sym2.forEach((e,t)=>{e.startsWith("F")||e.startsWith("^")?r+=`	${d[t]}::${e}
`:e>"~"?r+=`	${d[t]}::Send {${P(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::SendRaw ${e}
		return
`)}),r}function le(){let r="";return a.symShift.forEach((e,t)=>{e=="%"?r+=`	${d[t]}::sendRaw \`%
		return
`:e>"~"?r+=`	${d[t]}::send {${P(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::sendRaw ${e}
		return
`)}),r}function P(r){switch(r){case"\u26A0\uFE0F":return"U+26a0}{U+fe0f";default:return`U+${r.codePointAt(0).toString(16)}`}}function O(r,e=0){return e?`	${r}::ChangeBrightness(CurrentBrightness < 100 - brightnessJump ? CurrentBrightness += brightnessJump : 100)
    return
`:`	${r}::ChangeBrightness(CurrentBrightness > brightnessJump ? CurrentBrightness -= brightnessJump : 0)
    return
`}function T(r){return new Promise(e=>setTimeout(e,r))}const j=document.createElement("ol");L.split(`
`).forEach((r,e)=>{const t=document.createElement("li");t.textContent=r,j.appendChild(t)});const y=document.createElement("button");y.id="copyBtn";y.textContent="copy";const g=document.createElement("span");y.prepend(g);let C;y.addEventListener("click",async()=>{await navigator.clipboard.writeText(L),!C&&(C=!0,g.textContent="copied \u2713",g.style.opacity=1,await T(1500),g.style.opacity=0,await T(500),g.textContent="",C=!1)},{once:!1});const B=document.createElement("div");B.id="ahkCtx";B.append(y,j);const G=document.createElement("div");G.id="kbdCtx";G.append(M,U);const z=document.createElement("main");z.append(G,B);X(z);document.body.append(z);k();ae();console.log("\u{1F4A1}\u{1F4A1}done\u{1F4A1}\u{1F4A1}");
