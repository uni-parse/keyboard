...
.  .  \u2717  \u32BF F5 F11  . .  F12 F6  .  .  .
.      .   .         .         .   .   .   .`},H=o.standard;ee();o.shift=V(o.standard);o.symShift=V(o.sym,!1);o.standardHtk=o.standard.map(r=>S(r));o.extHtk=o.ext.map(r=>S(r));o.ext2Htk=o.ext2.map(r=>S(r));o.standardRows=N(H);o.standardHtkRows=N(H.split("").map(r=>S(r)).join(""));function ee(){Object.entries(o).forEach(([r,e])=>o[r]=e.replace(`
`,"").replaceAll(`
`," ").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(" "))}function N(r){const e=["top","upper","home","lower","bottom"],t=r.replace(`
`,"").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(`
`);return t.forEach((a,s)=>t[s]=a.split(" ")),Object.fromEntries(e.map((a,s)=>[a,t[s]]))}function V(r,e=!0){return r.map(t=>{if(e&&t==".")return">";switch(t){case"`":return"~";case"1":return"!";case"2":return"@";case"3":return"#";case"4":return"$";case"5":return"%";case"6":return"^";case"7":return"&";case"8":return"*";case"9":return"(";case"0":return")";case"=":return"+";case"-":return"_";case"\\":return"|";case"/":return"?";case"[":return"{";case"]":return"}";case",":return"<";case";":return":";case"'":return'"';default:return t.length==1&&t>="a"&&t<="z"?t.toUpperCase():t}})}function S(r){switch(r){case"\u{1F4B2}":return"F23";case"\u2B50":return"F24";case"\u2297":return"Esc";case"\u238B":return"Esc";case"\u21C4":return"Tab";case"\u23CE":return"Enter";case"\u21EA":return"Capslock";case"\u21E7":return"LShift";case"\u2A01":return"LCtrl";case"\u229E":return"LWin";case"\u2263":return"AppsKey";case"\u232B":return"Bs";case"\u2326":return"Del";case"\u21F1":return"Home";case"\u21F2":return"End";case"\u21DE":return"PgUp";case"\u21DF":return"PgDn";case"\u2191":return"Up";case"\u2193":return"Down";case"\u2192":return"Right";case"\u2190":return"Left";case"\u25B4":return"mouseU";case"\u25BE":return"mouseD";case"\u25B8":return"mouseR";case"\u25C2":return"mouseL";case"\u25F4":return"LButton";case"\u25F7":return"RButton";case"\u29BA":return"MButton";case"\u21A9":return"XButton1";case"\u21AA":return"XButton2";case"\u21C8":return"WheelDown";case"\u21CA":return"WheelUp";case"\u2387":return"speed";case"\u23EF":return"Media_Play_Pause";case"\u25FC":return"Media_Stop";case"\u23ED":return"Media_Next";case"\u23EE":return"Media_Prev";case"\u{1F507}":return"Volume_Mute";case"\u{1F50A}":return"Volume_Up";case"\u{1F509}":return"Volume_Down";case"\u2600":return"brightnessUp";case"\u2733":return"brightnessDown";case"\u{1F50D}":return"Browser_Search";case"\u229A":return"^Numpad0";case"\u2295":return"^NumpadAdd";case"\u229D":return"^NumpadSub";case"\u2399":return"PrintScreen";case"\u{1F4F1}":return"Run calc";case"%":return"`%";case";":return"`;";default:return r}}const M=document.createElement("div");M.id="keyboard";for(let[r,e]of Object.entries(o.standardRows)){const t=document.createElement("div");t.id=`${r}_row`,t.className="row",e.forEach((a,s)=>{const c=document.createElement("button");c.textContent=a,c.className=te(o.standardHtkRows[r][s]),"\u232B \u21C4 \u23CE alt \u21E7 \u229E \u2A01 \u{1F4B2} space \u2B50 \u2263".split(" ").includes(a)&&c.classList.add("modifier"),t.append(c)}),M.append(t)}function te(r){if(+r||r==0)return`_${r}`;switch(r){case"`":return"backtick";case"-":return"hyphon";case"=":return"equal";case"/":return"slash";case"\\":return"backSlash";case"[":return"openBreacket";case"]":return"closeBracket";case"'":return"quate";case"`;":return"semiColon";case",":return"comma";case".":return"period";default:return r}}const Y=document.createElement("legend");Y.innerText="layout switcher";const h=document.createElement("fieldset");h.id="switcher";h.append(Y);h.name="layer";ne("power","standard","shift","ext","ext2","sym","symShift","sym2");function re(){const r=document.querySelectorAll("#keyboard button");h.addEventListener("change",({target:{value:e}})=>r.forEach((t,a)=>t.textContent=o[e][a]))}function ne(...r){r.forEach(e=>{const t=document.createElement("label"),a=document.createElement("input");a.type="radio",a.id=`radio_${e}`,a.name="layer",a.value=e,e=="standard"&&a.setAttribute("checked",!0),t.id=`label_${e}`,t.append(a,e),h.append(t)})}var se="./assets/UniParse.0f63fbec.zip",ae="./assets/msklc.100e6e50.zip";const C=document.createElement("a");C.textContent="MsKLC";C.download="msklc.zip";C.href=ae;const E=document.createElement("a");E.textContent="AutoHotKey";E.download="autohotkey.zip";E.href=se;const B=document.createElement("div");B.id="download";B.append(C,E);const G=document.createElement("div");G.id="panel";G.append(h,B);var oe="./assets/pop1.b5fe646f.wav",ce="./assets/pop2.5719bcba.wav",ie="./assets/pop3.4711d144.wav";const W=[oe,ce,ie];W.forEach(r=>new Audio(r));const le=M.querySelectorAll("button");function de(){document.addEventListener("keydown",({key:r,code:e})=>{console.log(e,r);const t=[].find.call(le,a=>a.innerText==r||a.className.split(" ").find(s=>s==r||s=="_"+r||s=="space"&&r==" "||s=="LShift"&&r=="Shift"));!t||(new Audio(W[Math.floor(Math.random()*3)]).play(),t.style.borderStyle="inset",t.className.includes("modifier")?t.style.backgroundColor="darkcyan":t.style.backgroundColor="#333",document.addEventListener("keyup",function a({key:s}){r==s&&(document.removeEventListener("keyup",a),t.style.borderStyle="outset",t.className.includes("modifier")?t.style.backgroundColor="#222":t.style.backgroundColor="#666")},{once:!1}))})}const i="F23",l="F24",w=[-400,2],f={symKey:i,extKey:l};f.intro=`;
;
;   made by UniParse
;   github.com/TheUniParse
...
`;f.switchers=`	${i}::
  ...
  double_${l}_timer:
    press_${l} = 0
    Return`;f.layer_condition={sym:`!layer_sym2 && ((layer_sym && !GetKeyState("${l}", "P")) || (!layer_sym && GetKeyState("${i}", "P") && !GetKeyState("${l}", "P")) || (layer_ext && GetKeyState("${i}", "P")))`,sym1:`GetKeyState("${i}", "P") && GetKeyState("${l}", "P")`,sym2:"layer_sym2",ext:`!layer_ext2 && ((layer_ext && !GetKeyState("${i}", "P")) || (!layer_ext && GetKeyState("${l}", "P") && !GetKeyState("${i}", "P")) || (layer_sym && GetKeyState("${l}", "P")))`,ext2:"layer_ext2"};const x={};x.getWheel=(r,e,t)=>`	*${e}::
    if !scroll_${e} {
      If press_${e}
        press_${e} = 2
      Else {
  ...
  speed_${e}_timer:
    ...
    press_${e} = 0
    Return
`;x.getHover=(r,e,t,a,s)=>{return c(e)+c(a)+c(t)+c(s);function c(n){return`	${n}::
    If !move_${n} {
      if !GetKeyState("${n==s||n==t?e:s}","P") && !GetKeyState("${n==s||n==t?a:t}","P") && !GetKeyState("${u(n)}","P") {
        If press_${n}
          press_${n} = 2
        Else {
          press_${n} = 1
  ...
  move_${n}_timer:
    If GetKeyState("${n}","P") && (layer_ext ? 1 : GetKeyState("${r}","P")) {
      if (move_${n} = move__nth) {
        ...
        If !GetKeyState("${n==s||n==t?e:s}","P") && !GetKeyState("${n==s||n==t?a:t}","P")
          MouseMove, ${$(n)},, R
        else if GetKeyState("${n==s||n==t?e:s}","P")
          MouseMove, ${$(n,1)},, R
        else if GetKeyState("${n==s||n==t?a:t}","P")
          MouseMove, ${$(n,2)},, R
      } ;else do nothing
    } Else {
      if !GetKeyState("${n==s||n==t?e:s}","P") && !GetKeyState("${n==s||n==t?a:t}","P") && !GetKeyState("${u(n)}","P") {
  ...
  speed_${n}_timer:
    ...
    press_${n} = 0
    Return
`;function $(p,U=0){if(U){if(U==1){if(p==e||p==s)return"-x, -y";if(p==t)return"x, -y";if(p==a)return"-x, y"}else if(U==2){if(p==e)return"x, -y";if(p==t||p==a)return"x, y";if(p==s)return"-x, y"}}else{if(p==e)return"0, -y";if(p==t)return"x, 0";if(p==a)return"0, y";if(p==s)return"-x, 0"}}function u(p){if(p==s)return t;if(p==t)return s;if(p==e)return a;if(p==a)return e}}};const d=o.standard.map(r=>r==";"?"`;":r);let J,L,j,q;const Q=`${f.intro}
...
#If ${f.layer_condition.ext}
${x.getHover(f.extKey,j,L,q,J)}
${x.getWheel(f.extKey,"q","wheelUp")}
${x.getWheel(f.extKey,"a","wheelDown")}#If`;function A(r=0){let e="";return o[r?"ext2Htk":"extHtk"].forEach((t,a)=>{switch(t){case"LButton":case"RButton":case"MButton":case"XButton1":case"XButton2":e+=`	${d[a]}::${t}
`;break;case"Capslock":e+=`	${d[a]}::SetCapsLockState, % GetKeyState("CapsLock","T") ? "Off" : "On"
		return
`;break;case"mouseL":J=d[a];break;case"mouseR":L=d[a];break;case"mouseU":j=d[a];break;case"mouseD":q=d[a];break;case"brightnessUp":e+=I(d[a],1);break;case"brightnessDown":e+=I(d[a]);break;case"speed":e+=`	${d[a]}::
		speed_switcher := !speed_switcher
		resetSpeed()
		return
`;break;default:t!="."&&!t.includes("mouse")&&!t.includes("Wheel")&&(e+=`	${d[a]}::${t}
`)}}),e}function pe(){let r="";return o.sym.forEach((e,t)=>{+e||"0`\\/=[]".includes(e)?r+=`	${d[t]}::${e}
`:e>"~"?r+=`	${d[t]}::Send {${z(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::SendRaw ${e}
		return
`)}),r}function fe(){let r="";return o.sym2.forEach((e,t)=>{e.startsWith("F")||e.startsWith("^")?r+=`	${d[t]}::${e}
`:e>"~"?r+=`	${d[t]}::Send {${z(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::SendRaw ${e}
		return
`)}),r}function ue(){let r="";return o.symShift.forEach((e,t)=>{e=="%"?r+=`	${d[t]}::sendRaw \`%
		return
`:e>"~"?r+=`	${d[t]}::send {${z(e)}}
		return
`:e!="."&&(r+=`	${d[t]}::sendRaw ${e}
		return
`)}),r}function z(r){switch(r){case"\u26A0\uFE0F":return"U+26a0}{U+fe0f";default:return`U+${r.codePointAt(0).toString(16)}`}}function I(r,e=0){return e?`	${r}::ChangeBrightness(CurrentBrightness < 100 - brightnessJump ? CurrentBrightness += brightnessJump : 100)
    return
`:`	${r}::ChangeBrightness(CurrentBrightness > brightnessJump ? CurrentBrightness -= brightnessJump : 0)
    return
`}function F(r){return new Promise(e=>setTimeout(e,r))}const X=document.createElement("ol");Q.split(`
`).forEach((r,e)=>{const t=document.createElement("li");t.textContent=r,X.appendChild(t)});const y=document.createElement("button");y.id="copyBtn";y.textContent="copy";const g=document.createElement("span");y.prepend(g);let P;y.addEventListener("click",async()=>{await navigator.clipboard.writeText(Q),!P&&(P=!0,g.textContent="copied \u2713",g.style.opacity=1,await F(1500),g.style.opacity=0,await F(500),g.textContent="",P=!1)},{once:!1});const K=document.createElement("div");K.id="ahkCtx";K.append(y,X);const O=document.createElement("div");O.id="kbdCtx";O.append(M,G);const T=document.createElement("main");T.append(O,K);D(T);document.body.append(T);re();de();console.log("\u{1F4A1}\u{1F4A1}done\u{1F4A1}\u{1F4A1}");
