const P = function () { const r = document.createElement("link").relList; if (r && r.supports && r.supports("modulepreload")) return; for (const d of document.querySelectorAll('link[rel="modulepreload"]')) n(d); new MutationObserver(d => { for (const i of d) if (i.type === "childList") for (const t of i.addedNodes) t.tagName === "LINK" && t.rel === "modulepreload" && n(t) }).observe(document, { childList: !0, subtree: !0 }); function a(d) { const i = {}; return d.integrity && (i.integrity = d.integrity), d.referrerpolicy && (i.referrerPolicy = d.referrerpolicy), d.crossorigin === "use-credentials" ? i.credentials = "include" : d.crossorigin === "anonymous" ? i.credentials = "omit" : i.credentials = "same-origin", i } function n(d) { if (d.ep) return; d.ep = !0; const i = a(d); fetch(d.href, i) } }; P(); const U = [["`", ["", "` ~"], ["Capslock", "\u21EA"], "\u22C6"], ["1", ["", "1 !"], ["Browser_Search", "\u{1F50D}"], "\u25AA", "\u2152"], ["2", ["", "2 @"], ["Media_Stop", "\u25FC"], "\u25B8", "\xBD"], ["3", ["", "3 #"], ["Media_Prev", "\u23EE"], "{", "\u2153"], ["4", ["", "4 $"], ["Media_Next", "\u23ED"], "}", "\xBC"], ["5", ["", "5 %"], ["", ""], "\xBB", "\u2155 "], ["6", ["", "6 ^"], ["", ""], ["", " "], ""], ["\\", ["", "\\ |", ""], ["", ""], ["", " "], ""], ["7", ["", "7 &"], ["", ""], "\u203A", "\xBE"], ["8", ["", "8 *"], ["^Numpad0", "\u229A"], "\u2022", "\u2070"], ["9", ["", "9 ("], ["^NumpadAdd", "\u2295"], "<", "\u2264"], ["0", ["", "0 )"], ["^NumpadSub", "\u229D"], ">", "\u2265"], ["=", ["", "= +"], ["Volume_Mute", "\u{1F507}"], "\u2043"], ["Bs", ["", "\u232B"]], ["Tab", ["", "\u21C4"]], ["q", "", ["WheelUp", "\u21C8"], "@", "\u{1F4A1}"], ["w", "", ["Esc", "\u2297"], "#", "\u26A0\uFE0F"], ["f", "", ["mouseU", "\u25B4"], "$", "\u2191"], ["p", "", ["speed", "\u2387"], "`%", "\u03C0"], ["b", "", ["", ""], "~", "\u2248"], ["[", ["", "[ {"], ["", "\u2600"], "\u221A", "\u2209"], ["j", "", ["PgUp", "\u21DE"], "^", "F12"], ["l", "", ["Home", "\u21F1"], [7, "7 &"], "F7"], ["u", "", ["Up", "\u2191"], [8, "8 *"], "F8"], ["y", "", ["End", "\u21F2"], [9, "9 ("], "F9"], ["'", ["", `' "`], ["Volume_Down", "\u{1F509}"], ["`", "` ~"], "\u2026"], ["-", ["", "- _"], ["Volume_Up", "\u{1F50A}"], "+", "\xB1"], ["Enter", ["", "\u23CE"]], ["LAlt", ["", "Alt"]], ["a", "", ["WheelDown", "\u21CA"], ["/", "/ ?"], "\xD7"], ["r", "", ["mouseL", "\u25C2"], "(", "\u2190"], ["s", "", ["mouseD", "\u25BE"], ")", "\u2193"], ["t", "", ["mouseR", "\u25B8"], ["=", "= +"], "\u2192"], ["g", "", ["AppsKey", "\u2263"], "!", "\u2260"], ["]", ["", "] }"], ["", "\u2733"], "\u20AC", "\u2208"], ["m", "", ["PgDn", "\u21DF"], "*", "F11"], ["n", "", ["Left", "\u2190"], [4, "4 $"], "F4"], ["e", "", ["Down", "\u2193"], [5, "5 `%"], "F5"], ["i", "", ["Right", "\u2192"], [6, "6 ^"], "F6"], ["o", "", ["Enter", "\u23CE"], ":", "\xD8"], ["`;", ["", "; :"], ["Media_Play_Pause", "\u23EF"], ["\\", "\\ |"], "\u221E"], ["LShift", ["", "\u21E7"]], ["SC056", ["", "\u21E7"]], ["x", "", ["XButton1", "\u21A9"], ["[", "[ {"], "\u2717"], ["c", "", ["XButton2", "\u21AA"], ["]", "] }"], "\u32BF"], ["d", "", ["Bs", "\u232B"], "&", "\u24B9"], ["v", "", ["Del", "\u2326"], "|", "\u2713"], ["z", "", ["PrintScreen", "\u2399"], "_", "\xB2"], ["/", ["", "/ ?"], ["Run calc", "\u{1F4F1}"], "?", "\xF7"], ["k", "", ["Tab", "\u21C4"], [0, "0 )"], "F10"], ["h", "", ["LButton", "\u25F4"], [1, "1 !"], "F1"], [",", ["", ", <"], ["MButton", "\u29BA"], [2, "2 @"], "F2"], [".", ["", ". >"], ["RButton", "\u25F7"], [3, "3 #"], "F3"], ["RShift", ["", "\u21E7"]], ["LWin", ["", "\u229E"]], ["LCtrl", ["", "Ctrl"]], ["F23", ["", "Sym"]], ["Space", ["", ""]], ["F24", ["", "Ext"]], ["RCtrl", ["", "Ctrl"]], ["RCtrl", ["", "Ctrl"]], ["AppsKey", ["", "\u2263"]]]; function E(l, r, a, n, d) {
  function i(t) {
...
`, l.forEach(e => {
    typeof e[2] == "object" && e[2][0] && (e[2][0].includes("Button") ? o += `	F24 & ${e[0]}::${e[2][0]}
...
#If layer_ext
`, l.forEach(e => {
    typeof e[2] == "object" && e[2][0] && (e[2][0].includes("Button") ? o += `	${e[0]}::${e[2][0]}
...
`, l.forEach(e => {
    typeof e[3] == "object" && (e[3][0] || e[3][0] == 0) ? typeof e[3][0] == "number" || e[3][0] == "`" || e[3][0] == "\\" || e[3][0] == "/" || e[3][0] == "=" || e[3][0] == "[" || e[3][0] == "]" ? o += `	F23 & ${e[0]}::${e[3][0]}
...
#If layer_sym
`, l.forEach(e => {
    typeof e[3] == "object" && (e[3][0] || e[3][0] == 0) ? typeof e[3][0] == "number" || e[3][0] == "`" || e[3][0] == "\\" || e[3][0] == "/" || e[3][0] == "=" || e[3][0] == "[" || e[3][0] == "]" ? o += `	${e[0]}::${e[3][0]}
...
#If layer_sym2
`, l.forEach(e => {
    typeof e[4] == "object" && e[4][0] ? o += `${e[4] && !(typeof e[4] == "object" && !e[4][0]) ? `	F23 & ${e[0]}::${typeof e[4] == "object" ? e[4][0] : e[4]}
