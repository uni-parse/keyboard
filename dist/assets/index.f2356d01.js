var Te=(e,r)=>()=>(r||e((r={exports:{}}).exports,r),r.exports);var pt=Te((yt,N)=>{const Pe=function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const f of d.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&s(f)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerpolicy&&(d.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?d.credentials="include":o.crossorigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function s(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}};Pe();function A(e){return new Promise(r=>setTimeout(r,e))}function re(e,r){return new Promise(t=>e.addEventListener(r,t,{once:!0}))}async function De(e,r,t){let s=await Ie(e);s=="pending"&&(await r(),s=await Promise.all(e),await(t==null?void 0:t()))}async function Ie(e){if(!Array.isArray(e)){const t={};return await Promise.race([e,t]).then(s=>s===t?"pending":"fulfilled").catch(()=>"rejected")}const r=new Set;for(const t of e){const s={},o=await Promise.race([t,s]).then(d=>d===s?"pending":"fulfilled").catch(()=>"rejected");if(o=="rejected")return o;r.add(o)}return r.has("pending")?"pending":"fulfilled"}var Re="./assets/mediaIcons.5c839f27.json",We="./assets/UniParse.75cadb2a.avif 66w, ./assets/UniParse.8d145562.webp 66w";let R={name:"uniparse",side:"right",srcset:We,urls:["https://youtube.com/channel/UCvNOch5x46MDaejgQ6SkzUg","https://facebook.com/UniParse","https://instagram.com/UniParse","https://linkedin.com/in/UniParse","https://github.com/TheUniParse","https://twitter.com/UniParse"]};async function je(e,r=0,t=2500){const s=await Fe();e.append(s);const o=s.querySelector("img.userMedias");await re(o,"load"),await A(r),Ge(t)}async function Fe(){const e=document.createElement("address");e.id="mediaIcons";const r=await Be(),t=R.urls.map(o=>{const d=document.createElement("a");d.target="_blank",d.href=o;const f=o.slice(8,o.indexOf(".")),g=r[f];d.innerHTML=g;const p=d.querySelector("svg");p.role="img";const v=document.createElement("title");return v.innerText=`${f} of ${R.name}`,p.prepend(v),d});e.append(...t);const s=document.createElement("img");return s.srcset=R.srcset,s.alt=R.name,s.className="userMedias",e.append(s),R=null,e}async function Ge(e=2500){const r=document.querySelector("#mediaIcons");r.style.transform="translateY(-.3rem)";let t,s;r.querySelector("img").addEventListener("click",f),r.addEventListener("pointerenter",async()=>{clearTimeout(s),await re(r,"pointerleave"),s=setTimeout(()=>{t&&f()},e)},{once:!1});const d=r.querySelectorAll("a");function f(){d.forEach((g,p)=>{const v=60*(t?p:d.length-p),J=t?".3, -1,      1, 1":" 0,  0,     .7, 2";g.style.transition=`transform 200ms ${v}ms cubic-bezier(${J})`,g.style.transform=t?"":"translateX(0)"}),t=!t}}async function Be(){return await(await fetch(Re)).json()}const h={power:`
...
.  .  \u2717  \u32BF F5 F11  . .  F12 F6  .  .  .
.      .   .         .         .   .   .   .`},fe=h.standard;$e();h.shift=he(h.standard);h.symShift=he(h.sym,!1);h.standardHtk=h.standard.map(U);h.extHtk=h.ext.map(U);h.ext2Htk=h.ext2.map(U);h.standardRows=ye(fe);h.standardHtkRows=ye(fe.split("").map(U).join(""));function $e(){Object.entries(h).forEach(([e,r])=>h[e]=r.replace(`
`,"").replaceAll(`
`," ").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(" "))}function ye(e){const r=["top","upper","home","lower","bottom"],t=e.replace(`
`,"").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(`
`);return t.forEach((s,o)=>t[o]=s.split(" ")),Object.fromEntries(r.map((s,o)=>[s,t[o]]))}function he(e,r=!0){return e.map(t=>{if(r&&t==".")return">";switch(t){case"`":return"~";case"1":return"!";case"2":return"@";case"3":return"#";case"4":return"$";case"5":return"%";case"6":return"^";case"7":return"&";case"8":return"*";case"9":return"(";case"0":return")";case"=":return"+";case"-":return"_";case"\\":return"|";case"/":return"?";case"[":return"{";case"]":return"}";case",":return"<";case";":return":";case"'":return'"';default:return t.length==1&&t>="a"&&t<="z"?t.toUpperCase():t}})}function U(e){switch(e){case"\u{1F4B2}":return"F23";case"\u2B50":return"F24";case"\u2297":return"Esc";case"\u238B":return"Esc";case"\u21C4":return"Tab";case"\u23CE":return"Enter";case"\u21EA":return"Capslock";case"\u21E7":return"LShift";case"\u2A01":return"LCtrl";case"\u229E":return"LWin";case"\u2263":return"AppsKey";case"\u232B":return"Bs";case"\u2326":return"Del";case"\u21F1":return"Home";case"\u21F2":return"End";case"\u21DE":return"PgUp";case"\u21DF":return"PgDn";case"\u2191":return"Up";case"\u2193":return"Down";case"\u2192":return"Right";case"\u2190":return"Left";case"\u25B4":return"mouseU";case"\u25BE":return"mouseD";case"\u25B8":return"mouseR";case"\u25C2":return"mouseL";case"\u25F4":return"LButton";case"\u25F7":return"RButton";case"\u29BA":return"MButton";case"\u21A9":return"XButton1";case"\u21AA":return"XButton2";case"\u21C8":return"WheelUp";case"\u21CA":return"WheelDown";case"\u2387":return"toggleMouseSpeed";case"\u23EF":return"Media_Play_Pause";case"\u25FC":return"Media_Stop";case"\u23ED":return"Media_Next";case"\u23EE":return"Media_Prev";case"\u{1F507}":return"Volume_Mute";case"\u{1F50A}":return"Volume_Up";case"\u{1F509}":return"Volume_Down";case"\u2600":return"brightnessUp";case"\u2733":return"brightnessDown";case"\u{1F50D}":return"Browser_Search";case"\u229A":return"^Numpad0";case"\u2295":return"^NumpadAdd";case"\u229D":return"^NumpadSub";case"\u2399":return"PrintScreen";case"\u{1F4F1}":return'Run("calc")';case"%":return"`%";case";":return"`;";default:return e}}function Ke(e){const r=e.querySelectorAll("button");t("pinkey",1,2,13,16,26,27,30,40,41),t("ring",3,12,17,25,31,39,45,54),t("middle",5,10,18,24,32,38,46,53),t("indexL",6,7,19,20,33,34,47,48,49),t("indexR",9,22,23,36,37,50,51,52),t("dark",1,2,3,5,6,7,9,10,12,13,22,27,41,49,50),t("mix_ring_middle",4),t("mix_middle_ring",11),t("mix_index_top",8),t("mix_index_upper",21),t("mix_index_home",35),t("highLight",30,31,32,33,37,38,39,40,47,52,58,60);function t(s,...o){o.forEach(d=>{r[d-1].classList.add(s)})}}var Ne="./assets/pop1.b5fe646f.wav",Ue="./assets/pop2.5719bcba.wav",He="./assets/pop3.4711d144.wav";const oe=[Ne,Ue,He];function Oe(e=0,r=[]){return r.push(new Promise(t=>setTimeout(t,e)),...oe.map((t,s)=>Ve(s,qe(t)))),r}function ze(){const e=document.querySelectorAll("#keyboard button");document.addEventListener("keydown",r=>{const{key:t,code:s}=r;console.log(s,t);const o=Array.prototype.find.call(e,d=>d.innerText==t||d.classList.contains(t)||d.classList.contains("_"+t)||d.classList.contains("space")&&t==" "||d.classList.contains("LShift")&&t=="Shift");!o||(oe[Math.floor(Math.random()*3)].play(),o.style.boxShadow="0 0 1px 0 #111",o.style.transform="translate(0.1em, 0.1em)",document.addEventListener("keyup",function d({key:f}){t==f&&(document.removeEventListener("keyup",d),o.style.boxShadow="",o.style.transform="")},{once:!1}))})}async function qe(e){const r=new AudioContext,t=await fetch(e),s=await t.arrayBuffer(),o=await r.decodeAudioData(s);function d(){const f=r.createBufferSource();return f.buffer=o,f.connect(r.destination),f.start(r.currentTime),f}return{play:d}}async function Ve(e,r){oe[e]=await r}const H=document.createElement("div");H.id="keyboard";const Ye=[...Object.entries(h.standardRows)],Je=Ye.map(([e,r])=>{const t=document.createElement("div");t.id=`${e}_row`,t.className="row";const s=r.map((o,d)=>{const f=document.createElement("button");return f.textContent=o,f.className=Xe(h.standardHtkRows[e][d]),"\u232B \u21C4 \u23CE alt \u21E7 \u229E \u2A01 \u{1F4B2} space \u2B50 \u2263".split(" ").includes(o)&&f.classList.add("modifier"),f});return t.append(...s),t});H.append(...Je);Ke(H);function Xe(e){if(+e||e==0)return`_${e}`;switch(e){case"`":return"backtick";case"-":return"hyphon";case"=":return"equal";case"/":return"slash";case"\\":return"backSlash";case"[":return"openBreacket";case"]":return"closeBracket";case"'":return"quate";case"`;":return"semiColon";case",":return"comma";case".":return"period";default:return e}}var Qe="./assets/UniParse.eb0bb88e.zip",Ze="./assets/msklc.100e6e50.zip";const T=document.createElement("fieldset");T.id="switcher";T.name="layer";const ge=document.createElement("legend");ge.innerText="layout switcher";T.append(ge);const et="power standard shift ext ext2 sym symShift sym2",tt=et.split(" ").map(e=>{const r=document.createElement("label");r.id=`label_${e}`;const t=document.createElement("input");return t.type="radio",t.id=`radio_${e}`,t.name="layer",t.value=e,e=="standard"&&t.setAttribute("checked",!0),r.append(t,e),r});T.append(...tt);function rt(){const e=document.querySelectorAll("#keyboard button");T.addEventListener("change",r=>e.forEach((t,s)=>t.textContent=h[r.target.value][s]))}const O=document.createElement("div");O.id="panel";O.append(T);const z=document.createElement("div");z.id="download";O.append(z);const q=document.createElement("a");q.textContent="MsKLC";q.download="msklc.zip";q.href=Ze;z.append(q);const V=document.createElement("a");V.textContent="AutoHotKey";V.download="autohotkey.zip";V.href=Qe;z.append(V);const ne="F23",ae="F24",x={symKey:ne,extKey:ae};x.intro=`;
;
;   made by UniParse
...
)`,sym1:'GetKeyState(extendKey, "P") && GetKeyState(symbolKey, "P")',sym2:'layers.get("sym2")'};x.config=`extendKey := "${ae}"
symbolKey := "${ne}"
...
}`;function ot(e,r,t,s){return`mouse := {
  keys: Map(
    "up", "${e}",
    "down", "${t}",
    "right", "${r}",
...
`}function d(g){switch(g){case e:return"up";case r:return"down"}}function f(g){switch(g){case e:return"WheelUp";case r:return"WheelDown"}}}function at(){return`; setBrightness(0)
...
`}const S=h.standard.map(e=>e==";"?"`;":e);let be,_e,we,xe,Ce,ke;const Ee=`${x.intro}
...
${ot(we,_e,xe,be)}`;function pe(e){return h[e].reduce((r,t,s)=>{if(t==".")return r;switch(t){case"WheelUp":return r+`	*${Ce=S[s]}::wheelScroll_up()
`;case"WheelDown":return r+`	*${ke=S[s]}::wheelScroll_down()
`}switch(r+=`	${S[s]}::`,t){case"mouseU":r+='mouse_move("up")',we=S[s];break;case"mouseD":r+='mouse_move("down")',xe=S[s];break;case"mouseL":r+='mouse_move("left")',be=S[s];break;case"mouseR":r+='mouse_move("right")',_e=S[s];break;case"toggleMouseSpeed":case"brightnessUp":case"brightnessDown":r+=`${t}()`;break;case"Capslock":r+='SetCapsLockState(!GetKeyState("CapsLock", "T"))';break;default:r+=t}return r+`
`},"")}function it(){return h.sym.reduce((e,r,t)=>r=="."?e:(e+=`	${S[t]}::`,e+=+r||"0`\\/=[]".includes(r)?r:ie(r),e+`
`),"")}function lt(){return h.sym2.reduce((e,r,t)=>r=="."?e:(e+=`	${S[t]}::`,e+=r.startsWith("F")||r.startsWith("^")?r:ie(r),e+`
`),"")}function st(){return h.symShift.reduce((e,r,t)=>r=="."?e:e+`	${S[t]}::${ie(r)}
`,"")}function ct(e){switch(e){case"\u26A0\uFE0F":return"U+26a0}{U+fe0f";default:return`U+${e.codePointAt(0).toString(16)}`}}function ie(e){return e=='"'?`SendText('"')`:e<="~"?`SendText("${e}")`:`Send("{${ct(e)}}")`}const ut=(window!=null?window:WorkerGlobalScope&&self instanceof WorkerGlobalScope)?self:{},j=(e=>{/**
