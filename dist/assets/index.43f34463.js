const z=function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))n(d);new MutationObserver(d=>{for(const i of d)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&n(t)}).observe(document,{childList:!0,subtree:!0});function a(d){const i={};return d.integrity&&(i.integrity=d.integrity),d.referrerpolicy&&(i.referrerPolicy=d.referrerpolicy),d.crossorigin==="use-credentials"?i.credentials="include":d.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(d){if(d.ep)return;d.ep=!0;const i=a(d);fetch(d.href,i)}};z();const U=[["`",["","` ~"],["Capslock","\u21EA"],"",""],["1",["","1 !"],["Browser_Search","\u{1F50D}"],"",""],["2",["","2 @"],["Media_Stop","\u25FC"],"",""],["3",["","3 #"],["Media_Prev","\u23EE"],"",""],["4",["","4 $"],["Media_Next","\u23ED"],""],["5",["","5 %"],"",""],["6",["","6 ^"]],["\\",["","\\ |"]],["7",["","7 &"]],["8",["","8 *"],["^Numpad0","\u229A"],""],["9",["","9 ("],["^NumpadAdd","\u2295"],""],["0",["","0 )"],["^NumpadSub","\u229D"],"","\u2026"],["=",["","= +"],["Volume_Mute","\u{1F507}"],"","\xB1"],["Bs",["","\u232B"]],["Tab",["","\u21C4"]],["q","",["WheelUp","\u21C8"]],["w","",["Esc","\u2297"],"{"],["f","",["mouseU","\u25B4"],"}"],["p","",["speed","\u2387"]],["b","",["PgUp","\u21DE"]],["[",["","[ {"],["","\u2600"]],["j","",["",""]],["l","",["Home","\u21F1"]],["u","",["Up","\u2191"],")"],["y","",["End","\u21F2"],"("],["'",["",`' "`],["Volume_Down","\u{1F509}"],["`","` ~"],"F11"],["-",["","- _"],["Volume_Up","\u{1F50A}"],["=","= +"],"F12"],["Enter",["","\u23CE"]],["LAlt",["","Alt"]],["a","",["WheelDown","\u21CA"],[1,"1 !"],"F1"],["r","",["mouseL","\u25C2"],[2,"2 @"],"F2"],["s","",["mouseD","\u25BE"],[3,"3 #"],"F3"],["t","",["mouseR","\u25B8"],[4,"4 $"],"F4"],["g","",["PgDn","\u21DF"]],["]",["","] }"],["","\u2600"]],["m","",["AppsKey","\u2263"]],["n","",["Left","\u2190"],[7,"7 &"],"F7"],["e","",["Down","\u2193"],[8,"8 *"],"F8"],["i","",["Right","\u2192"],[9,"9 ("],"F9"],["o","",["Enter","\u23CE"],[0,"0 )"],"F10"],["`;",["","; :"],["Media_Play_Pause","\u23EF"],":","\u2260"],["LCtrl",["","Ctrl"]],["SC056",["","Ctrl"]],["x","",["XButton1","\u21A9"],["[","[ {"]],["c","",["XButton2","\u21AA"],["]","] }"]],["d","",["Bs","\u232B"],[5,"5 %"],"F5"],["v","",["Del","\u2326"],["\\","\\ |"]],["z","",["PrintScreen","\u2399"],"",""],["/",["","/ ?"],["Run calc","\u{1F4F1}"],"",""],["k","",["Tab","\u21C4"],["/","/ ?"],""],["h","",["LButton","\u25F4"],[6,"6 ^"],"F6"],[",",["",", <"],["MButton","\u2A40"],"<","\u2264"],[".",["",". >"],["RButton","\u25F7"],">","\u2265"],["RCtrl",["","Ctrl"]],["LWin",["","\u229E"]],["LShift",["","\u21E7"]],["F23",["","Sym"]],["Space",["",""]],["F24",["","Ext"]],["RShift",["","\u21E7"]],["RShift",["","\u21E7"]],["AppsKey",["","\u2263"]]];function E(l,r,a,n,d){function i(t){function c(e,$=0){if($){if($==1){if(e==l||e==n)return"-x, -y";if(e==r)return"x, -y";if(e==a)return"-x, y"}else if($==2){if(e==l)return"x, -y";if(e==r||e==a)return"x, y";if(e==n)return"-x, y"}}else{if(e==l)return"0, -y";if(e==r)return"x, 0";if(e==a)return"0, y";if(e==n)return"-x, 0"}}function o(e){if(e==n)return r;if(e==r)return n;if(e==l)return a;if(e==a)return l}return`	${t}::
  ${d} & ${t}::
    If !move_${t} {
