...
.  .  \u2717  \u32BF F5 F11  . .  F12 F6  .  .  .
.      .   .         .         .   .   .   .`},F=u.standard;re();u.shift=I(u.standard);u.symShift=I(u.sym,!1);u.standardHtk=u.standard.map(t=>M(t));u.extHtk=u.ext.map(t=>M(t));u.ext2Htk=u.ext2.map(t=>M(t));u.standardRows=L(F);u.standardHtkRows=L(F.split("").map(t=>M(t)).join(""));function re(){Object.entries(u).forEach(([t,e])=>u[t]=e.replace(`
`,"").replaceAll(`
`," ").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(" "))}function L(t){const e=["top","upper","home","lower","bottom"],r=t.replace(`
`,"").replaceAll("    "," ").replaceAll("   "," ").replaceAll("  "," ").split(`
`);return r.forEach((o,s)=>r[s]=o.split(" ")),Object.fromEntries(e.map((o,s)=>[o,r[s]]))}function I(t,e=!0){return t.map(r=>{if(e&&r==".")return">";switch(r){case"`":return"~";case"1":return"!";case"2":return"@";case"3":return"#";case"4":return"$";case"5":return"%";case"6":return"^";case"7":return"&";case"8":return"*";case"9":return"(";case"0":return")";case"=":return"+";case"-":return"_";case"\\":return"|";case"/":return"?";case"[":return"{";case"]":return"}";case",":return"<";case";":return":";case"'":return'"';default:return r.length==1&&r>="a"&&r<="z"?r.toUpperCase():r}})}function M(t){switch(t){case"\u{1F4B2}":return"F23";case"\u2B50":return"F24";case"\u2297":return"Esc";case"\u238B":return"Esc";case"\u21C4":return"Tab";case"\u23CE":return"Enter";case"\u21EA":return"Capslock";case"\u21E7":return"LShift";case"\u2A01":return"LCtrl";case"\u229E":return"LWin";case"\u2263":return"AppsKey";case"\u232B":return"Bs";case"\u2326":return"Del";case"\u21F1":return"Home";case"\u21F2":return"End";case"\u21DE":return"PgUp";case"\u21DF":return"PgDn";case"\u2191":return"Up";case"\u2193":return"Down";case"\u2192":return"Right";case"\u2190":return"Left";case"\u25B4":return"mouseU";case"\u25BE":return"mouseD";case"\u25B8":return"mouseR";case"\u25C2":return"mouseL";case"\u25F4":return"LButton";case"\u25F7":return"RButton";case"\u29BA":return"MButton";case"\u21A9":return"XButton1";case"\u21AA":return"XButton2";case"\u21C8":return"WheelUp";case"\u21CA":return"WheelDown";case"\u2387":return"toggleMouseSpeed";case"\u23EF":return"Media_Play_Pause";case"\u25FC":return"Media_Stop";case"\u23ED":return"Media_Next";case"\u23EE":return"Media_Prev";case"\u{1F507}":return"Volume_Mute";case"\u{1F50A}":return"Volume_Up";case"\u{1F509}":return"Volume_Down";case"\u2600":return"brightnessUp";case"\u2733":return"brightnessDown";case"\u{1F50D}":return"Browser_Search";case"\u229A":return"^Numpad0";case"\u2295":return"^NumpadAdd";case"\u229D":return"^NumpadSub";case"\u2399":return"PrintScreen";case"\u{1F4F1}":return'Run( "calc")';case"%":return"`%";case";":return"`;";default:return t}}var se="./assets/pop1.b5fe646f.wav",oe="./assets/pop2.5719bcba.wav",ne="./assets/pop3.4711d144.wav";const V=[se,oe,ne];V.forEach(t=>new Audio(t));function ae(){const t=document.querySelectorAll("#keyboard button");document.addEventListener("keydown",e=>{const{key:r,code:o}=e;console.log(o,r);const s=[].find.call(t,l=>l.innerText==r||l.className.split(" ").find(d=>d==r||d=="_"+r||d=="space"&&r==" "||d=="LShift"&&r=="Shift"));!s||(new Audio(V[Math.floor(Math.random()*3)]).play(),s.style.borderStyle="inset",s.className.includes("modifier")?s.style.backgroundColor="darkcyan":s.style.backgroundColor="#333",document.addEventListener("keyup",function l({key:d}){r==d&&(document.removeEventListener("keyup",l),s.style.borderStyle="outset",s.className.includes("modifier")?s.style.backgroundColor="#222":s.style.backgroundColor="#666")},{once:!1}))})}const k=document.createElement("div");k.id="keyboard";const ce=[...Object.entries(u.standardRows)],le=ce.map(([t,e])=>{const r=document.createElement("div");r.id=`${t}_row`,r.className="row";const o=e.map((s,l)=>{const d=document.createElement("button");return d.textContent=s,d.className=ie(u.standardHtkRows[t][l]),"\u232B \u21C4 \u23CE alt \u21E7 \u229E \u2A01 \u{1F4B2} space \u2B50 \u2263".split(" ").includes(s)&&d.classList.add("modifier"),d});return r.append(...o),r});k.append(...le);function ie(t){if(+t||t==0)return`_${t}`;switch(t){case"`":return"backtick";case"-":return"hyphon";case"=":return"equal";case"/":return"slash";case"\\":return"backSlash";case"[":return"openBreacket";case"]":return"closeBracket";case"'":return"quate";case"`;":return"semiColon";case",":return"comma";case".":return"period";default:return t}}var ue="./assets/UniParse.0e221228.zip",de="./assets/msklc.100e6e50.zip";const y=document.createElement("fieldset");y.id="switcher";y.name="layer";const Y=document.createElement("legend");Y.innerText="layout switcher";y.append(Y);const pe="power standard shift ext ext2 sym symShift sym2",fe=pe.split(" ").map(t=>{const e=document.createElement("label");e.id=`label_${t}`;const r=document.createElement("input");return r.type="radio",r.id=`radio_${t}`,r.name="layer",r.value=t,t=="standard"&&r.setAttribute("checked",!0),e.append(r,t),e});y.append(...fe);function me(){const t=document.querySelectorAll("#keyboard button");y.addEventListener("change",e=>t.forEach((r,o)=>r.textContent=u[e.target.value][o]))}const U=document.createElement("div");U.id="panel";U.append(y);const P=document.createElement("div");P.id="download";U.append(P);const G=document.createElement("a");G.textContent="MsKLC";G.download="msklc.zip";G.href=de;P.append(G);const E=document.createElement("a");E.textContent="AutoHotKey";E.download="autohotkey.zip";E.href=ue;P.append(E);const h="F23",g="F24",f={symKey:h,extKey:g};f.intro=`;
;
;   made by UniParse
;   github.com/TheUniParse
...
`;f.switchers=`${h}::symSwitcher('${h}', 400, 200)
${g}::extSwitcher('${g}', 400, 200)`;f.layer_condition={ext:`!layer_ext2 && (
  (
    layer_ext
    && !GetKeyState("${h}", "P")
  ) || (
...
)`,sym1:`GetKeyState("${h}", "P") && GetKeyState("${g}", "P")`,sym2:"layer_sym2"};f.config=`layer_ext := 0
layer_ext2 := 0
layer_sym := 0
layer_sym2 := 0
...
double_ext_timer() {
  global
  switchers.pressCount_ext := 0
}`;function he(t,e,r,o,s){return`mouse := {
...
`+l(e)+l(o)+l(r)+l(s);function l(c){const n=a(c),p=c==s||c==r;return d(c,n,p)+v(c,n,p)}function d(c,n,p){return`
mouseMove_${n}() {
  global

  If mouse.moveCount_${n}
    return

  if GetKeyState("${p?e:s}","P") || GetKeyState("${p?o:r}","P") || GetKeyState("${i(c)}","P") {
    mouse.moveCount_${n} := ++mouse.moveCount
    SetTimer(mouse_${n}_moveCount_timer, A_MouseDelay)
    
    return
  }

  If !mouse.pressCount_${n} {
    mouse.pressCount_${n} := 1
    SetTimer(mouse_${n}_boostSpeed_timer, -300)
  } Else
    mouse.pressCount_${n} := 2
...
`}function v(c,n,p){return`
mouse_${n}_moveCount_timer() {
  global

  If GetKeyState("${c}","P") && (layer_ext || GetKeyState("${t}","P")) {
    if (mouse.moveCount_${n} != mouse.moveCount)
      return
    ...
    if GetKeyState("${p?e:s}","P")
      MouseMove(${C(c,1)},, 'R')
    else if GetKeyState("${p?o:r}","P")
      MouseMove(${C(c,2)},, 'R')
    else
      MouseMove(${C(c)},, 'R')
  ...
  if !GetKeyState("${p?e:s}","P") && !GetKeyState("${p?o:r}","P") && !GetKeyState("${i(c)}","P") {
    ...
    mouse.boostSpeed := 0
    mouse.moveCount := 0
  } Else if (mouse.moveCount_${n} = 1) {
    mouse.moveCount--
    if mouse.moveCount_${a(p?e:s)} > 1
      mouse.moveCount_${a(p?e:s)}--
    if mouse.moveCount_${a(p?o:r)} > 1
      mouse.moveCount_${a(p?o:r)}--
    if mouse.moveCount_${a(c,"opposite")} > 1
      mouse.moveCount_${a(c,"opposite")}--
  } Else if (mouse.moveCount_${n} = 2) {
    mouse.moveCount--
    if mouse.moveCount_${a(p?e:s)} > 2
      mouse.moveCount_${a(p?e:s)}--
    if mouse.moveCount_${a(p?o:r)} > 2
      mouse.moveCount_${a(p?o:r)}--
    if mouse.moveCount_${a(c,"opposite")} > 2
      mouse.moveCount_${a(c,"opposite")}--
  }

  mouse.moveCount_${n} := 0
  SetTimer( , 0)
}

mouse_${n}_boostSpeed_timer() {
  global
  if mouse.pressCount_${n} = 2
    mouse.boostSpeed := 1
  mouse.pressCount_${n} := 0
}
`}function a(c,n=!1){switch(c){case e:return n?"down":"up";case o:return n?"up":"down";case s:return n?"right":"left";case r:return n?"left":"right"}}function i(c){switch(c){case s:return r;case r:return s;case o:return e;case e:return o}}function C(c,n=0){if(n){if(n==1)switch(c){case e:case s:return"-x, -y";case r:return"x, -y";case o:return"-x, y"}else if(n==2)switch(c){case e:return"x, -y";case r:case o:return"x, y";case s:return"-x, y"}}else switch(c){case e:return"0, -y";case r:return"x, 0";case o:return"0, y";case s:return"-x, 0"}}}function ge(t,e,r){return`wheel := {
  boostSpeed_up: 0,
  boostSpeed_down: 0,
  scrolling_up: 0,
  scrolling_down: 0,
...
`+o(e)+o(r);function o(a){const i=d(a);return s(a,i)+l(a,i)}function s(a,i){return`
wheelScroll_${i}() {
  global
...
`}function l(a,i){return`
wheel_${i}_scrolling_timer() {
  global
  if GetKeyState("${a}","P") && (layer_ext || GetKeyState("${t}","P"))
    SendInput '{Blind}{${v(a)}}'
  Else {
    wheelDelay := wheelDelay_default
...
`}function d(a){switch(a){case e:return"up";case r:return"down"}}function v(a){switch(a){case e:return"WheelUp";case r:return"WheelDown"}}}function _e(){return`; setBrightness(0)
...
${_e()}
${ge(f.extKey,j,q)}
${he(f.extKey,J,W,N,H)}`;function T(t){return u[t].reduce((e,r,o)=>{if(r==".")return e;switch(r){case"WheelUp":return e+`	*${j=m[o]}::wheelScroll_up()
`;case"WheelDown":return e+`	*${q=m[o]}::wheelScroll_down()
`}switch(e+=`	${m[o]}::`,r){case"mouseU":e+="mouseMove_up()",J=m[o];break;case"mouseD":e+="mouseMove_down()",N=m[o];break;case"mouseL":e+="mouseMove_left()",H=m[o];break;case"mouseR":e+="mouseMove_right()",W=m[o];break;case"toggleMouseSpeed":case"brightnessUp":case"brightnessDown":e+=`${r}()`;break;case"Capslock":e+='SetCapsLockState(!GetKeyState("CapsLock","T"))';break;default:e+=r}return e+`
`},"")}function ye(){return u.sym.reduce((t,e,r)=>e=="."?t:(t+=`	${m[r]}::`,t+=+e||"0`\\/=[]".includes(e)?e:K(e),t+`
`),"")}function be(){return u.sym2.reduce((t,e,r)=>e=="."?t:(t+=`	${m[r]}::`,t+=e.startsWith("F")||e.startsWith("^")?e:K(e),t+`
`),"")}function xe(){return u.symShift.reduce((t,e,r)=>e=="."?t:t+`	${m[r]}::${K(e)}
`,"")}function we(t){switch(t){case"\u26A0\uFE0F":return"U+26a0}{U+fe0f";default:return`U+${t.codePointAt(0).toString(16)}`}}function K(t){return t<="~"?`SendText('${t}')`:`Send('{${we(t)}}')`}function A(t){return new Promise(e=>setTimeout(e,t))}const z=document.createElement("div");z.id="ahkCtx";const X=document.createElement("ol");z.append(X);const Se=Q.split(`
`).map(t=>{const e=document.createElement("li");return e.textContent=t,e});X.append(...Se);const S=document.createElement("button");S.id="copyBtn";S.textContent="copy";z.append(S);const b=document.createElement("span");S.prepend(b);let B;S.addEventListener("click",async()=>{await navigator.clipboard.writeText(Q),!B&&(B=!0,b.textContent="copied \u2713",b.style.opacity=1,await A(1500),b.style.opacity=0,await A(500),b.textContent="",B=!1)},{once:!1});const O=document.createElement("main");document.body.append(O);const D=document.createElement("div");D.id="kbdCtx";D.append(k,U);O.append(D,z);ee(O);me();ae();console.log("\u{1F4A1}\u{1F4A1}done\u{1F4A1}\u{1F4A1}");
